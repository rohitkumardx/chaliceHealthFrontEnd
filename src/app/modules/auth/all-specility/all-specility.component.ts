...
@Component({
  selector: 'app-all-specility',
  templateUrl: './all-specility.component.html',
  styleUrls: ['./all-specility.component.css'],
    animations: [
        trigger('fadeIn', [
          transition(':enter', [
            style({ opacity: 0 }),
...
export class AllSpecilityComponent implements OnInit {
...
console.log("local storage from all speciality :", this.userInfo);
}
speciality: any
getSpeciality() {
