...
@Component({
  selector: 'app-patient-message-complaint',
  templateUrl: './patient-message-complaint.component.html',
  styleUrls: ['./patient-message-complaint.component.css']
})
export class PatientMessageComplaintComponent implements OnInit {
  @Input() patientId: any
...
this.getMessageReportList()
  ...
  confirmComplaintMessage() {
    ...
    if (this.complaintForm.valid) {
      ...
      const postData = {
        complaintById: this.patientId,  // Ensure camelCase format
        complaintToId: this.providerId,  // Ensure camelCase format
