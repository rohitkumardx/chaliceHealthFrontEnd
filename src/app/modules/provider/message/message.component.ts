import { AfterViewInit, Component, ElementRef, HostListener, OnChanges, OnInit, ViewChild, SimpleChanges } from '@angular/core';
...
export class MessageComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnInit() {
    ...
    this.messageSubscription = this.signalRService.message$.subscribe(
      (newMessage) => {
         this.getMessageList();
        // if (this.router.url.includes('/provider/message')) {
        //   this.getMessageList();
        // }
  ...
  getMessageList() {
    this.providerService.getMessageList(this.receiverId).subscribe((response: any) => {
      ...
      const isMessagePage = (currentHref.includes('/provider/message') &&
        currentHref.includes('userId=') && currentHref.includes('appointmentId='))||(currentHref.includes('/provider/message')&&
  ...
  showSaveMessage() {
    ...
    this.providerService.getSavedMessagesList(this.userId).subscribe((response: any) => {
      ...
      console.log('saved ', this.savedMessages)
      this.getActiveMessage()

    })
    // this.isMessageVisible = !this.isMessageVisible;
    // alert(this.isMessageVisible)
  }
  activeReply: any;
  getActiveMessage() {
    ...
    this.providerService.getActiveMessageByUserId(this.userId).subscribe((response: any) => {
      ...
      console.log('active', this.activeReply)
      this.isMessageVisible = !this.isMessageVisible;
    })
  }
